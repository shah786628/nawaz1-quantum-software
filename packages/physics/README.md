...
The Physics package provides quantum simulation of fundamental physical systems through the unified VQE engine at 2^53-qubit scale. It encompasses **13 specialized sub-modules** covering the full spectrum of quantum physics — from quantum field theory and quantum gravity to quantum cosmology and metrology.
...
|---|-----------|------------|
| 1 | Quantum Field Theory  | QFT & Gauge Theory |
| 2 | Quantum Electrodynamics  | QED Interactions |
| 3 | Quantum Chromodynamics  | Strong Force |
| 4 | Relativistic Quantum Mechanics  | Relativistic Dynamics |
| 5 | Quantum Gravity  | Planck-Scale Physics |
| 6 | Quantum Entanglement Theory  | Bell Inequalities |
| 7 | Quantum Optics  | Photonic States |
| 8 | Quantum Thermodynamics  | Quantum Heat Engines |
| 9 | Quantum Chaos  | Random Matrix Theory |
| 10 | Open Quantum Systems  | Decoherence |
| 11 | Quantum Phase Transitions  | Critical Phenomena |
| 12 | Quantum Metrology  | Precision Measurement |
| 13 | Quantum Cosmology  | Early Universe |
...
Strong interaction physics with QCD coupling constants, quark condensate, gluon condensate. Lattice QCD simulations at 2^53-qubit scale.
...
Transverse field Ising model and phase diagram analysis. Quantum critical phenomena and symmetry breaking at 2^53-qubit scale.
...
- **Maximum lattice:** 256×256 sites (up to 2^53 spins)
...
- `"quantum_dynamics"` — Time-dependent quantum system evolution
- `"time_evolution"` — Hamiltonian evolution and spectral analysis
...
|---|---|---|
| Heisenberg | Spin-spin exchange interaction model | Magnetic systems, spin chains |
| Hubbard | Electron hopping and on-site repulsion | Strongly correlated electrons |
| Ising | Classical and transverse-field spin model | Phase transitions, optimization |
| Custom Operator | User-defined Hamiltonian matrix | Research, novel systems |
| Standard Model | Full gauge theory Hamiltonian | Particle physics, scattering |
...
### Encoding Options
- **Jordan-Wigner**: Fermion-to-qubit mapping (default for fermionic physics)
- **Bravyi-Kitaev**: Reduced gate depth for large systems
- **Direct Encoding**: For spin Hamiltonians and combinatorial problems
